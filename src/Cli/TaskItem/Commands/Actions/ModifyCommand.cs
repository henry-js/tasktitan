...
internal sealed class ModifyCommand(IAnsiConsole console, IStringFilterConverter<DateTime> dateConverter, ITtaskService service, ILogger<ModifyCommand> logger)
