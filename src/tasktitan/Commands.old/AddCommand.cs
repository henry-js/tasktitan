...
public sealed class AddCommand : Command
{
    ...
    public new class Handler(IAnsiConsole console, LiteDbContext dbContext, IOptions<TaskTitanConfig> options, ILogger<AddCommand> logger) : ICommandHandler
    {
        ...
        public async Task<int> InvokeAsync(InvocationContext context)
        {
            ...
            var taskId = dbContext.AddTask(Modification.Properties.Values);
